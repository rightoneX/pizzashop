		...
		<div class="order-table">
			...
			<?php foreach ($orders as $order) {  ?>
				<div class="order-row">
					...
					<div class="order-item-control"><a href="order_view.php?id=<?php echo $order['orderID'] ?>">[View]</a></div>
					<div class="order-item-control"><a href="order_edit.php?id=<?php echo $order['orderID'] ?>">[Edit]</a></div>
					<div class="order-item-control">
						<a href="order_delete.php?id=<?php echo $order['orderID'] ?>" onclick="return  confirm('Do you want to cancel your <?php echo $order['orderID'] ?> Order Y/N')">[Cancel]</a>
					</div>
				</div>
			<?php  }  ?>
		</div>
